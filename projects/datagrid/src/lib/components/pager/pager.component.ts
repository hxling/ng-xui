 ...
 * @LastEditTime: 2019-10-22 08:42:53
 * @QQ: 1055818239
 * @Version: v0.0.1
 */
...
@Component({
    ...
    template: `
    <div class="xui-datagrid-pager" #pagerContainer [ngStyle]="styles">
...
export class DatagridPagerComponent implements OnInit, AfterViewInit {
    ...
    @ViewChild('pagerContainer', {static: false}) pc: ElementRef;
    @ViewChild('pager', {static: false}) pager: PaginationControlsComponent;
